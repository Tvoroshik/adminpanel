...
const messages = {
    ...
    "ru": {
        ...
        "modelsExplorer": { // The "Models" tab on the left of the canvas
            ...
            "loadAllTip": "Загрузить всё Модели в этот проект",
            "unloadAll": "Убрать",
            "unloadAllTip": "Убрать всё Модели",
            "add": "Добавить",
        ...
        "objectsExplorer": { // The "Objects" tab on the left of the canvas
            ...
            "showAllTip": "Показать всё Объекты",
            "hideAll": "Скрыть всё",
            "hideAllTip": "Скрыть всё Объекты"
        },
        "classesExplorer": { // The "Classes" tab on the left of the canvas
            "title": "Классы",
            "showAll": "Показать всё",
            "showAllTip": "Показать всё Классы",
            "hideAll": "Скрыть всё",
            "hideAllTip": "Скрыть всё Классы"
        },
        "storeysExplorer": { // The "Storeys" tab on the left of the canvas
            "title": "История",
            "showAll": "Показать всё",
            "showAllTip": "Показать всё Истории",
            "hideAll": "Скрыть всё",
            "hideAllTip": "Скрыть все Истории"
        },
        "propertiesInspector": { // The "Properties" tab on the right of the canvas
            "title": "Параметры"
        },
        "toolbar": { // The toolbar at the top of the canvas
            "toggleExplorer": "Дерево обьектов", // Button to open or close the explorer panel on the left
            "resetViewTip": "Домой", // Button to reset the viewer to initial state
            "toggle2d3dTip": "Переключение 2D/3D", // Button to toggle between 3D view and 2D plan view modes
            "togglePerspectiveTip": "Ортогональная проекция", // Button to toggle between perspective and orthographic projection
            "viewFitTip": "Общий вид", // Button to position the camera to fit all objects in view
            "firstPersonTip": "Переключение на просмотр от первого лица", // Button to switch between first-person and orbit navigation modes
            "hideObjectsTip": "Скрыть обьекты", // Button to activate "Hide objects" tool
            "selectObjectsTip": "Выделить обьекты", // Button to activate "Select objects" tool
            "queryObjectsTip": "Query objects", // Button to activate "Query objects" tool
            "sliceObjectsTip": "Сделать срез", // Button to activate "Slice objects" tool
            "slicesMenuTip": "Меню срезов", // Button to open the pull-down menu of existing section planes
            "numSlicesTip": "Количество срезов" // Label shows number of sexisting section planes
        },
        "canvasContextMenu": { // Context menu that appears when we right-click on empty canvas space
            "viewFitAll": "Показать всё", // Menu option to position the camera to fit all objects in view
            "hideAll": "Скрыть всё", // Menu option to hide all objects
            "showAll": "Показать всё", // Menu option to show all objects
            "xRayAll": "X-Ray Всё", // Menu option to X-ray all objects
            "xRayNone": "X-Ray Ничего", // Menu option to remove X-ray effect from all objects
            "selectNone": "Сбросить выбор", // Menu option to clear any currently selected objects
            "resetView": "Сбросить вид", // Menu option to reset the view to initial state
            "clearSlices": "Убрать срёзы" // Menu option to delete all section planes created with the Slice tool
        },
        "modelsContextMenu": { // Context menu that appears when we right-click on a model in the "Models" tab
            "loadModel": "Загрузить",
            "unloadModel": "Не загружать",
            "editModel": "Редактировать",
            "deleteModel": "Удалить",
            "loadAllModels": "Загрузить всё",
            "unloadAllModels": "Не загружать всё",
            "clearSlices": "Убрать срезы"
        },
        "objectContextMenu": { // Context menu that appears when we right-click on an object in the 3D view
            "viewFit": "Показать выделенное", // Menu option to position the camera to fit the object in view
            "viewFitAll": "Показать всё", // Menu option to position the camera to fit all objects in view
            "showInTree": "Показать в дереве", // Menu option to show the object in the Objects tab's tree
            "hide": "Скрыть", // Menu option to hide this object
            "hideOthers": "Скрыть остальное", // Menu option to hide other objects
            "hideAll": "Скрыть всё", // Menu option to hide all objects
            "showAll": "Показать всё", // Menu option to show all objects
            "xray": "X-Ray", // Menu option to X-ray this object
            "xrayOthers": "X-Ray Остальные", // Menu option to undo X-ray on all other objects
            "xrayAll": "X-Ray Всё", // Menu option to X-ray all objects
            "xrayNone": "X-Ray Убрать", // Menu option to remove X-ray effect from all objects
            "select": "Выбрать", // Menu option to select this object
            "undoSelect": "Отменить выбор", // Menu option to deselect this object
            "selectNone": "Отменить выбор от всего", // Menu option to deselect all objects
            "clearSlices": "Убрать срезы" // Menu option to delete all slices made with the Slicing tool
        },
        "treeViewContextMenu": { // Context menu that appears when we right-click an object node in the tree within in the "Objects" tab
            "viewFit": "Показать вид", // Menu option to position the camera to fit the object in view
            "viewFitAll": "Показать всё", // Menu option to position the camera to fit all objects in view
            ...
            "showOthers": "Показать остальное", // Menu option to hide this object and show all others
            "showAll": "Показать всё", // Menu option to show all objects
            "xray": "X-Ray", // Menu option to X-ray this object
            "undoXray": "Отменить X-Ray", // Menu option to undo X-ray on this object
            "xrayOthers": "X-Ray Остальное", // Menu option to undo X-ray on all other objects
            "xrayAll": "X-Ray Всё", // Menu option to X-ray all objects
            "xrayNone": "X-Ray Убрать", // Menu option to remove X-ray effect from all objects
            "select": "Выбрать", // Menu option to select this object
            "undoSelect": "Отменить Выбор", // Menu option to deselect this object
            "selectNone": "Снять всё выбранное", // Menu option to deselect all objects
            "clearSlices": "Убрать срёзы" // Menu option to delete all slices made with the Slicing tool
        },
        "sectionToolContextMenu": { // Context menu that appears when we right-click an the Slicing tool
            "slice": "Срез", // Title of submenu for each slice, eg. "Slice #0, Slice #1" etc
            "clearSlices": "Убрать срёзы", // Menu option to delete all slices
            "flipSlices": "Перевернуть срёзы", // Menu option to reverse the cutting direction of all slices
            "edit": "Редактировать", // Sub-menu option to edit a single slice
            "flip": "Перевернуть", // Sub-menu option to reverse the cutting direction of a single slice
